...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2024 at 05:57 PM
...
-- Database: `mavericks`
--
CREATE DATABASE IF NOT EXISTS `mavericks` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mavericks`;
...
('root', '[{\"db\":\"mavericks\",\"table\":\"delivery_registration\"},{\"db\":\"mavericks\",\"table\":\"users\"},{\"db\":\"mavericks\",\"table\":\"payments\"},{\"db\":\"mavericks\",\"table\":\"members\"},{\"db\":\"mavericks\",\"table\":\"contact\"},{\"db\":\"delivery\",\"table\":\"delivery_registration\"},{\"db\":\"payment\",\"table\":\"payments\"},{\"db\":\"mydatabase\",\"table\":\"members\"},{\"db\":\"login\",\"table\":\"users\"},{\"db\":\"contactus\",\"table\":\"contact\"}]');
...
('root', '2024-05-09 15:56:47', '{\"Console\\/Mode\":\"collapse\"}');
